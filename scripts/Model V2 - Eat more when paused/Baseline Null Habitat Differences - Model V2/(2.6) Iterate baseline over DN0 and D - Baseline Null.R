...
## Export DF.QA
#write.csv(DF.DN0, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.DN0.V2.Baseline-Null.csv")
...
## Export DF.D
#write.csv(DF.D, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.D.V2.csv")


# Join DF.DN0 and DF.D
DF.DN0$d <- rep(1, length(DF.DN0$Wstart)) # make d column and set all values to 1
DF.D$dn0 <- rep(1, length(DF.D$Wstart)) # make dn0 column and set all values to 1
...
## Export DF.D
write.csv(DF.D, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.D.V2.Baseline-Null.csv")
DF.D <- read.csv("H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.D.V2.Baseline-Null.csv", sep=",")
