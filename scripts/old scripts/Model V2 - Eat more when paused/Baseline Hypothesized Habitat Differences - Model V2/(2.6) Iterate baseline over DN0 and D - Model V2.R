...
## Export DF.QA
write.csv(DF.DN0, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.DN0.V2.csv")
...
## Export DF.D
write.csv(DF.D, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.D.V2.csv")
DF.D <- read.csv("H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.D.V2.csv", sep=",")
