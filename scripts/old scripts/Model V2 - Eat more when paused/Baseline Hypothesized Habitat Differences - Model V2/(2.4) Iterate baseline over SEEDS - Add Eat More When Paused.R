...
write.csv(DF.SEEDS, "H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.SEEDS.V2.csv")
DF.SEEDS <- read.csv("H:\\My Drive\\Professional\\GIT Repositories\\SDP-pred-mig\\results\\DF.SEEDS.V2.csv", sep=",")
