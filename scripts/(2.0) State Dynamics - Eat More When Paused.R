...
sim.mix[1,2] <- 7.1 # set starting values for mass, 10g
...
(sim.mix[30,2] - sim.mix[1,2]) / 30  # daily river growth 0.0133 g/day (E = 0.02), 0.045 (E=0.3)
(sim.mix[60,2] - sim.mix[31,2]) / 30  # daily ocean growth 0.131 g/day (E = 0.02), .0278 (E=0.3)
